...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinkedList<com.example.recyclerview.model.Word> mWordList = mDataSource.loadWords();
...
// binding.contentMain.recyclerview remplace findViewById(R.id.recyclerview)
        ...
        binding.fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mWordList.addLast(new com.example.recyclerview.model.Word("+ Word " + wordListSize));
