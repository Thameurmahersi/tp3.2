...
public class WordListAdapter extends
    ...
    private final LinkedList<com.example.recyclerview.model.Word> mWordList;
    public WordListAdapter(LinkedList<com.example.recyclerview.model.Word> mWordList) {
    ...
    public void onBindViewHolder(@NonNull WordListAdapter.WordViewHolder holder, int position) {
        com.example.recyclerview.model.Word mCurrent = mWordList.get(position);
...
// Utilisez cela pour accéder à l'élément affecté dans mWordList.
            com.example.recyclerview.model.Word element = mWordList.get(mPosition);
